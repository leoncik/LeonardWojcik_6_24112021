...
## [1.0.0] - 2022-01-27
### Added
-   New dependencies : [Autoprefixer](https://github.com/postcss/autoprefixer)
-   Video controls inside lightbox.
-   Several picture sizes.
-   Improved accessibility (more focus redirection and ARIA attributes).
-   Complete styling.

### Fixed
-   Broken paths on GitHub.


## [0.3.4] - 2022-01-16
### Added
-   Custom dropdown selelect menu for sorting medias.

## [0.3.3] - 2022-01-12
### Added
-   Accessibility features (ARIA and keyboard navigation).
-   Styling for the index page (complete) and photographer page (WIP).

## [0.3.2] - 2022-01-06
### Fixed
-   Index problem after sorting medias.
